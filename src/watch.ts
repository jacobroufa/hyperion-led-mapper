...
/**
 * Taken from Shoelace: https://github.com/shoelace-style/shoelace/blob/next/src/internal/watch.ts
 * 
 ...
 * }
 */
export default function watch(propertyName: string | string[], options?: WatchOptions) {
